document.addEventListener('DOMContentLoaded', () => {
    const section = document.getElementById('idFeatures');
    ...
    function animateGroups() {
      const groups = document.querySelectorAll('#idFeatures [data-group]');
      ...
      uniqueGroups.forEach((groupId, index) => {
        const groupItems = document.querySelectorAll(`#idFeatures [data-group="${groupId}"]`);
        setTimeout(() => {
